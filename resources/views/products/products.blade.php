...
@section('content')
    ...
    @If(session()->has('Add_product'))
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong> {{ session()->get('Add_product') }}</strong>
    ...
    <div class="row">
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                           data-toggle="modal" data-target="#addProductModal">اضافة منتج</a>
                    </div>
        ...
        <!--/div-->
        <!-- add -->
        <div class="modal fade" id="addProductModal" tabindex="-1" role="dialog" aria-labelledby="#addProductModel"
             aria-hidden="true">
